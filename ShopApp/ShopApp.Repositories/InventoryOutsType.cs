...
namespace ShopApp.Repositories
{
    public class InventoryOutsTypesRepository : DataLayer.GenericRepository<Entities.InventoryOutsType>,RepositoryAbstracts.IInventoryOutsTypesRepository
    {
        ...
        public List<Entities.InventoryOutsType> GetByDeletedDate(DateTime? value)
        {
            return RunQuery("SELECT * FROM [dbo].[InventoryOutsTypes] WHERE [DeletedDate] = @Value", new SqlParameter("Value", value));
        }
        public List<Entities.InventoryOutsType> GetByDeletedByUserId(int? value)
        {
