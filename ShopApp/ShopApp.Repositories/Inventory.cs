...
namespace ShopApp.Repositories
{
    public class InventoriesRepository : DataLayer.GenericRepository<Entities.Inventory>,RepositoryAbstracts.IInventoriesRepository
    {
        ...
        public List<Entities.Inventory> GetByDeletedDate(DateTime? value)
        {
            return RunQuery("SELECT * FROM [dbo].[Inventories] WHERE [DeletedDate] = @Value", new SqlParameter("Value", value));
        }
