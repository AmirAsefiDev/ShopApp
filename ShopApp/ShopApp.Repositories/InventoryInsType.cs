...
namespace ShopApp.Repositories
{
    public class InventoryInsTypesRepository : DataLayer.GenericRepository<Entities.InventoryInsType>,RepositoryAbstracts.IInventoryInsTypesRepository
    {
        ...
        public List<Entities.InventoryInsType> GetByDeletedDate(DateTime? value)
        {
            return RunQuery("SELECT * FROM [dbo].[InventoryInsTypes] WHERE [DeletedDate] = @Value", new SqlParameter("Value", value));
        }
