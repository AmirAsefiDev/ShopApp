...
namespace ShopApp.Repositories
{
    public class InventoryOutsDetailsRepository : DataLayer.GenericRepository<Entities.InventoryOutsDetail>,RepositoryAbstracts.IInventoryOutsDetailsRepository
    {
        ...
        public List<Entities.InventoryOutsDetail> GetByInventoryInsHeaderId(long value)
        {
            return RunQuery("SELECT * FROM [dbo].[InventoryOutsDetails] WHERE [InventoryInsHeaderId] = @Value", new SqlParameter("Value", value));
        }
