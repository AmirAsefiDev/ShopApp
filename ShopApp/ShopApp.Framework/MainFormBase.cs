...
namespace ShopApp.Framework
{
    public partial class MainFormBase : Form
    {
        ...
        public MainFormBase()
        {
            ...
            {
                toolstripLabel.Text = DateTime.Now.ToString("تاریخ: dd MMM yyyy   ساعت: hh:mm:ss");
            };
        ...
        public ViewEngine ViewEngine
        {
            ...
            {
                if (viewEngine == null)
                    viewEngine = new ViewEngine(tabControl1,TypesRegistery);
                return viewEngine;
            } 
        }
        ...
        protected StructureMap.Registry TypesRegistery { get; set; }
    }
}
